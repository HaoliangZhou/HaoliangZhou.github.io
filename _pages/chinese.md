...
- [Emotion-aware Adaptation of CLIP model for Facial Expression Recognition]( https:), Jing Huan, Mingxing Li, **Haoliang Zhou**. Artificial Intelligence Review, 2025 (SCI, 中科院一区TOP, IF=13.9)
- [PSN: Parallel Spatiotemporal Network to Recognize Micro-Expression]( https://doi.org/10.1016/j.neucom.2025.129891), Jingting Li, Sujing Wang, Yong Wang, **Haoliang Zhou**, Xiaolan Fu, Neurocomputing, 2025 (SCI, 中科院二区TOP, IF=6.5, CCF-C)
...
<!-- - *2023.03-2024.09*, 中国科学院自动化研究所 多模态人工智能系统全国重点实验室 [多媒体计算组 (MMC)]((https://nlpr-web.ia.ac.cn/mmc/index.html)), 客座学生（实习） -->
